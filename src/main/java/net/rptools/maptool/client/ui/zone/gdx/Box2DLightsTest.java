...
public class Box2DLightsTest extends InputAdapter implements ApplicationListener {
  ...
  public void render() {
    ...
    if (showText) {
      ...
      font.draw(
          batch, "F10 - over-burn blending (default in 1.2)", 0, Gdx.graphics.getHeight() - 135);
  ...
  void initChainLights() {
    ...
    for (int i = 0; i < BALLSNUM; i++) {
      ChainLight light =
          new ChainLight(
              rayHandler, RAYS_PER_BALL, null, LIGHT_DISTANCE, 1, new float[] {-5, 0, 0, 3, 5, 0});
  ...
  void initDirectionalLight() {
    ...
    DirectionalLight light =
        new DirectionalLight(rayHandler, 4 * RAYS_PER_BALL, null, sunDirection);
    lights.add(light);
  }

  private static final int MAX_FPS = 30;
  private static final int MIN_FPS = 15;
  public static final float TIME_STEP = 1f / MAX_FPS;
  ...
  /** Type of lights to use: 0 - PointLight 1 - ConeLight 2 - ChainLight 3 - DirectionalLight */
  int lightsType = 0;
