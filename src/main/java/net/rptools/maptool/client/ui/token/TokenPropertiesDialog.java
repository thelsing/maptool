...
public class TokenPropertiesDialog {
  ...
  private void $$$setupUI$$$() {
    ...
    tabPanel.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.properties"),
        panel3);
    ...
    panel5.setBorder(
        BorderFactory.createTitledBorder(
            ...
            this.$$$getMessageFromBundle$$$(
                "net/rptools/maptool/language/i18n", "EditTokenDialog.border.title.vbl.preview"),
    ...
    this.$$$loadLabelText$$$(
        label2,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.button.vbl.preview"));
    panel5.add(
        label2,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        checkBox1,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.vbl.preview"));
    ...
    this.$$$loadButtonText$$$(
        checkBox2,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.vbl.invert"));
    ...
    this.$$$loadButtonText$$$(
        checkBox3,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.option.vbl.erase"));
    ...
    this.$$$loadButtonText$$$(
        checkBox4,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.vbl.over"));
    ...
    tabPanel.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.ownership"),
        panel10);
    ...
    this.$$$loadButtonText$$$(
        checkBox5,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.allplayers"));
    panel10.add(
        checkBox5,
        new GridConstraints(
            0,
    ...
    tabPanel.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.config"),
        panel11);
    final JLabel label11 = new JLabel();
    this.$$$loadLabelText$$$(
        label11,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.shape"));
    panel11.add(
        label11,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label12,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.snaptogrid"));
    panel11.add(
        label12,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label13,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.size"));
    panel11.add(
        label13,
        new GridConstraints(
            1,
    ...
    this.$$$loadLabelText$$$(
        label14,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.visible.owner"));
    panel11.add(
        label14,
        new GridConstraints(
            1,
    ...
    this.$$$loadLabelText$$$(
        label15,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.visible"));
    panel11.add(
        label15,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label16,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.terrain.mod"));
    label16.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.terrain.mod.tooltip"));
    panel11.add(
        label16,
        new GridConstraints(
            1,
    ...
    comboBox4.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.combo.terrain.mod"));
    panel11.add(
        comboBox4,
        new GridConstraints(
            1,
    ...
    this.$$$loadLabelText$$$(
        label17,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.properties"));
    panel11.add(
        label17,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label18,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.opacity"));
    label18.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.opacity.tooltip"));
    panel11.add(
        label18,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label19,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.sight.has"));
    panel11.add(
        label19,
        new GridConstraints(
            3,
    ...
    panel13.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(new Color(-16777216)),
            this.$$$getMessageFromBundle$$$(
                "net/rptools/maptool/language/i18n", "EditTokenDialog.border.title.layout"),
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$("Dialog", Font.BOLD, 12, panel13.getFont()),
            new Color(-13538620)));
    ...
    panel14.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(new Color(-16777216)),
            this.$$$getMessageFromBundle$$$(
                "net/rptools/maptool/language/i18n", "EditTokenDialog.border.title.portrait"),
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$("Dialog", Font.BOLD, 12, panel14.getFont()),
            new Color(-13538620)));
    ...
    panel15.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(new Color(-16777216)),
            this.$$$getMessageFromBundle$$$(
                "net/rptools/maptool/language/i18n", "EditTokenDialog.border.title.handout"),
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$("Dialog", Font.BOLD, 12, panel15.getFont()),
            new Color(-13538620)));
    ...
    this.$$$loadLabelText$$$(
        label23,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.image"));
    panel11.add(
        label23,
        new GridConstraints(
            4,
    ...
    this.$$$loadLabelText$$$(
        label24,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.opacity.100"));
    panel11.add(
        label24,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label25,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.terrain.ignore"));
    label25.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.terrain.ignore.tooltip"));
    panel11.add(
        label25,
        new GridConstraints(
            2,
    ...
    tabPanel.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.libToken"),
        panel16);
    final JLabel label26 = new JLabel();
    this.$$$loadLabelText$$$(
        label26,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "Label.allowURIAccess"));
    panel16.add(
        label26,
        new GridConstraints(
            0,
    ...
    tabPanel.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.hero"),
        panel17);
    ...
    tabbedPane1.addTab(
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.tab.hero.xml"),
        panel19);
    ...
    this.$$$loadLabelText$$$(
        label29,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.hero.statBlockSearch"));
    panel19.add(
        label29,
        new GridConstraints(
            1,
    ...
    this.$$$loadButtonText$$$(
        button8,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.button.hero.setAsTokenPortrait"));
    panel21.add(
        button8,
        new GridConstraints(
            0,
    ...
    this.$$$loadButtonText$$$(
        button9,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.button.hero.setAsTokenImage"));
    panel21.add(
        button9,
        new GridConstraints(
            1,
    ...
    this.$$$loadButtonText$$$(
        button10,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.button.hero.setAsTokenHandout"));
    panel21.add(
        button10,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label32,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.hero.summary"));
    panel17.add(
        label32,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        label33,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.hero.portfolio"));
    panel17.add(
        label33,
        new GridConstraints(
            2,
    ...
    this.$$$loadLabelText$$$(
        label34,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.hero.last"));
    panel17.add(
        label34,
        new GridConstraints(
            3,
    ...
    this.$$$loadButtonText$$$(
        checkBox12,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.hero.isAlly"));
    panel17.add(
        checkBox12,
        new GridConstraints(
            3,
    ...
    this.$$$loadLabelText$$$(
        label40,
        this.$$$getMessageFromBundle$$$(
            "net/rptools/maptool/language/i18n", "EditTokenDialog.label.label"));
    headPanel.add(
        label40,
        new GridConstraints(
            2,
