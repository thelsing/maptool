...
public class HtmlEditorSplitGui {
    ...
    public HtmlEditorSplitGui() {
        ...
        sectionPanel.addBottomComponent(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_DOWN_MASK), findToolBar);
        sectionPanel.addBottomComponent(KeyStroke.getKeyStroke(KeyEvent.VK_H, InputEvent.CTRL_DOWN_MASK), replaceToolBar);
        ...
        Platform.runLater(() -> {
            ...
            sendAsEmoteItem.setOnAction(
                    e1 -> {
                        ...
                        String finalSelectedText = selectedText;
                        SwingUtilities.invokeLater(() -> {
                            MapTool.getFrame().getCommandPanel().commitCommand("/emit " + finalSelectedText);
