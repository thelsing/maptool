...
public class AppActionsFX {
    ...
    public static final Action SHOW_CONNECTION_INFO = new DefaultClientAction() {
        ...
        public void execute(ActionEvent e) {
            ...
            if (MapTool.getInstance().getServer() == null) {
                return;
            }

            ConnectionInfoDialog dialog = new ConnectionInfoDialog(MapTool.getInstance().getServer());
    ...
    public static final Action NEW_CAMPAIGN = new AdminClientAction() {
        ...
        /**
         * Displays a modal dialog asking Yes/No whether a new campaign should be started; this is here because MapTool doesn't have a confirmImpl() that allows the default button to be selected via a
         * parameter.
         * 
    ...
    public static final Action TOGGLE_MOVEMENT_LOCK = new AdminClientAction() {
        ...
        public void execute(ActionEvent e) {
            ...
            MapTool.getInstance().getServer().updateServerPolicy(policy);
        }
    };
    ...
    public static final LoadMapAction LOAD_MAP = new LoadMapAction() {
        ...
        public void execute(ActionEvent ae) {
            ...
            if (getSeenWarning() == false) {
                ...
                boolean isRemoteGM = isConnected && MapTool.getPlayer() != null && MapTool.getPlayer().isGM();
                isRemoteGM = true;
                if (isRemoteGM) {
