...
public class ZoomProcessor extends AbstractCursorProcessor {
	 ...
	 */
	public ZoomProcessor(JFrame graphicsContext){
		this(graphicsContext, graphicsContext.getWidth()/2);
	}
	 ...
	 * @param comp the comp
	 */
	private void endGesture(InputCursor inputEndedCursor, InputCursor leftOverCursor, Component comp){
