...
public class DragProcessor extends AbstractCursorProcessor {
    ...
    public DragProcessor(JFrame graphicsContext) {
     ...
     */
    public DragProcessor(JFrame graphicsContext, boolean stopEventPropagation) {
...
//		logger.setLevel(Level.DEBUG);
    ...
    private class DragContext {
        ...
        public DragContext(InputCursor c) {
            ...
            if (hasIntersection(dragObject, c))
                this.startPosition = c.getFirstEvent().getPosition();
            else {
        ...
        public void updateDragPosition() {
            if (dragObject == null) { //IF component was destroyed while gesture still active
